...
// Также имеется другое решение, оно является наиболее удачным. Сложность оценивается как O(n). Но, к сожалению, оно не доработано: возвращает [6, 7] вместо первой пары. Подскажите, что нужно изменить?
// function firstSum(arr, total) {
