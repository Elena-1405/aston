...
3. 
// a b c (первый resolve передается в then (a), к res добывляем b, затем с, finally выполняется, но не влияет на результат, .catch игнорируем, тк произошел resolve)
